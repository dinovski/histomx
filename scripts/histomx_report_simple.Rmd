...
## reference set quantiles
ms_ref <- newPreds$ref_scores[,c("Dx", "g0_score", "ptc0_score", "cg0_score", "i1_score", "t1_score", "v0_score", "iifta0_score", "cv1_score", "ci1_score", "ct1_score", "Q")]
...
```
Banff lesion based scores represent the probability that a biopsy has a Banff score >0 or >1, as indicated for each lesion.  
