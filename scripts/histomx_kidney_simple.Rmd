...
ms_ref <- newPreds$ref_scores[,c("Dx", "AMR", "TCMR", "IFTA", "Q")]
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, include=TRUE}
ms_new <- data.frame(t(newPreds$score_table[,c("g0_binary", "ptc0_binary", 
"i1_binary", "t1_binary","cg0_binary", "iifta0_binary", "v0_binary", "cv1_binary", "ci1_binary", "ct1_binary")]))
rownames(ms_new) <- gsub("\\_binary", "", rownames(ms_new))

## reference set quantiles
ms_ref <- newPreds$ref_scores[,c("Dx", "g0_binary", "ptc0_binary", 
"i1_binary", "t1_binary","cg0_binary", "iifta0_binary", "v0_binary", "cv1_binary", "ci1_binary", "ct1_binary", "Q")]
