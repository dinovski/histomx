...
ms_new <- data.frame(t(newPreds$score_table[,c("g0_score", "ptc0_score", "i1_score", "t1_score", "cg0_score", "iifta0_score", "v0_score", "cv1_score", "ci1_score", "ct1_score")]))

## reference set quantiles
ms_ref <- newPreds$ref_scores[,c("Dx", "g0_score", "ptc0_score", "i1_score", "t1_score", "cg0_score", "iifta0_score", "v0_score", "cv1_score", "ci1_score", "ct1_score", "Q")]
