...
```
The above Banff lesion based probabilities are for each score.
...
bkv_df <- bkv_df[rownames(bkv_df) %in% c("normal_median", "bkv_median", "new_counts", "new_normal_pval", "new_bkv_pval", "bkv_normal_pval"),]
