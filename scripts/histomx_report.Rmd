...
```{r, echo=FALSE, warning=FALSE, comment=FALSE, results='asis', fig.align='center', fig.cap='Normalized gene expression of Polyomavirus BK VP1 and Polyomavirus BK Large T Antigen in the test sample and reference biopsies with BKV or no specific diagnosis/lesions'}
