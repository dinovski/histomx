...
ms_new <- data.frame(t(newPreds$score_table[,c("AMR", "TCMR", "aTCMR", "caTCMR", "IFTA")]))
## exclude 'normal' molecular score

## reference set quantiles
ms_ref <- newPreds$ref_scores[,c("Dx", "AMR", "TCMR", "aTCMR", "caTCMR", "normal", "IFTA", "Q")]
...
tab[rownames(tab)=="aTCMR","No lesion Q1"] <- ms_ref[ms_ref$Dx=="No specific Dx" & ms_ref$Q=="25%","aTCMR"]
tab[rownames(tab)=="aTCMR","No lesion Q3"] <- ms_ref[ms_ref$Dx=="No specific Dx" & ms_ref$Q=="75%","aTCMR"]

## reference biopsy chronic actve TCMR molecular score ranges
tab[rownames(tab)=="caTCMR","No lesion Q1"] <- ms_ref[ms_ref$Dx=="No specific Dx" & ms_ref$Q=="25%","caTCMR"]
tab[rownames(tab)=="caTCMR","No lesion Q3"] <- ms_ref[ms_ref$Dx=="No specific Dx" & ms_ref$Q=="75%","caTCMR"]
