...
```
FoV=fields of view | geo mean=geometric mean | PCL=positive control linearity | 
LoD=limit of detection | BD=binding density | SNratio=geo mean HK genes / LoD

__Recommended QC thresholds:__  
Registered FoVs>75% | PCL>0.95 | BD 0.05-2.25 | 50% ENDO genes>LoD | POS_E counts>LoD | SNratio>1 (Samples failing any of these QC flags should be interpreted with caution)
