...
### Pathway analysis
<div style="margin-bottom:20px;">
```{r, echo=FALSE, warning=FALSE, comment=FALSE, results='asis', fig.align='center', fig.cap='Enrichment of genes with expression in the tested biopsy greater than 2 standard deviations of the median expression in all normal biopsies associated with the listed pathway.'}
...
### Cell-type analysis
<div style="margin-bottom:20px;">
```{r, echo=FALSE, warning=FALSE, comment=FALSE, results='asis', fig.align='center', fig.cap='Enrichment of genes with expression in the tested biopsy greater than 2 standard deviations of the median expression in all normal biopsies associated with the listed cell type.'}
